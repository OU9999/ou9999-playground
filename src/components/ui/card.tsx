...
const Card = ({ title, badge, image }: CardProps) => {
  const badgeString = getBadgeString(badge);

  return (
    <div className="min-h-72 rounded-md flex flex-col overflow-hidden border cursor-pointer transition-colors hover:border-slate-50">
